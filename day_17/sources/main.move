...
module challenge::day_17 {
    ...
    //entry function can triggered directly by a user wallet.
    entry fun create_farm(ctx: &mut TxContext) {
        let farm=new_farm(ctx);
        transfer::share_object(farm); //accessible to everyone it. no owner.
    }

    //We are performing planting and harvesting operations through the Farm object.
