...
#[test_only]
module challenge::day_06_tests {
    use std::string;
    use challenge::day_06::{Self, Habit};
    #[test]
    fun test_new_habit() {
        let name_str = string::utf8(b"Su Ic");
        let habit = day_06::new_habit(name_str);
    }
    #[test]
    fun test_make_habit_from_bytes() {
        let name_bytes = b"Kitap Oku";
        let habit = day_06::make_habit(name_bytes);
    }
}
