...
module challenge::day_14 {
    ...
    fun test_complete_task() {
        let owner=@0x1;
        let mut board=new_board(owner);
        let task1=new_task(string::utf8(b"Write Code"),100);
        let task2=new_task(string::utf8(b"Sleep"),200);
        add_task(&mut board,task1);
    ...
    fun test_total_reward() {
        let owner=@0x1;
        let mut board=new_board(owner);
        let task1=new_task(string::utf8(b"Write Code"),50);
        let task2=new_task(string::utf8(b"Sleep"),100);
        add_task(&mut board,task1);
        add_task(&mut board,task2);
